...
public class ProxyPessoaRepositorio extends PessoaRepositorio implements ProxyPessoaPolimorfismo {

    private static Logger log = Logger.getLogger(ProxyPessoaRepositorio.class.getName());
