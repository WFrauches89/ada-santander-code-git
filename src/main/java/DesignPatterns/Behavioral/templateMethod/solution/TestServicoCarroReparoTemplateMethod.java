...
import DesignPatterns.Behavioral.templateMethod.solution.Template.CarroReparoServiceTemplateMethod;
...
public class TestServicoCarroReparoTemplateMethod {
    public static void main(String[] args) {
        ...
        CarroReparoServiceTemplateMethod ccs = new CarroComumServiceTemplateMethod(vrc);
        ccs.reparaVeiculo();

        System.out.println("\n#############Comum 71+ ################");
        VeiculoReparo vrc2 = new VeiculoReparo();
        vrc2.setPorcentagemDano(71);
        CarroReparoServiceTemplateMethod ccs2 = new CarroComumServiceTemplateMethod(vrc2);
        ccs2.reparaVeiculo();

        System.out.println("\n#############Luxo até 50################");
        VeiculoReparo vrl = new VeiculoReparo();
        vrl.setPorcentagemDano(50);
        CarroReparoServiceTemplateMethod cls = new CarroLuxoServiceTemplateMethod(vrl);
        cls.reparaVeiculo();

        System.out.println("\n#############Luxo 51+ ################");
        VeiculoReparo vrl2 = new VeiculoReparo();
        vrl2.setPorcentagemDano(51);
        CarroReparoServiceTemplateMethod cls2 = new CarroLuxoServiceTemplateMethod(vrl2);
        cls2.reparaVeiculo();
    }
}
